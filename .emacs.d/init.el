...
(custom-set-variables
 ...
 '(package-selected-packages
   '(markdown-mode ox-gfm projectile counsel doom-themes org-bullets evil-snipe evil)))
(custom-set-faces
...
;; text-mode-hook affects markdown files as well as org mode files, likely among others like .txt files as well.
;; so these settings will affect both markdown files as well as org mode files
